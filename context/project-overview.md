...
3. Let users import prebuilt starte system designs into the canvas.
...
3. User enters the project workpace
...
- Live cursosrs, presence indicators, and node/edge editing.
...
- Templates are stativ canvas snapshots loaded directly into the active room.
- Covers common patterns: monolith, microservices , event-driven, serveless, and more.
...
- Collaborator accesss by project
